...
> 2026-05-21 注：本文已经过长，后续实验、诊断和验收记录不再继续追加到本文。每个新步骤在 `pdocs/grhsim_opt` 下新建独立 `NOxxxx_*.md` 文档，本文仅作为 ESSENT/MFFC 主线历史索引。
...
从 `NO0109` 起的独立实验、A/B 和 runtime 记录已拆分为本目录下的单篇 `NOxxxx_*.md` 文档；本文不再继续承载新的实验流水账。
