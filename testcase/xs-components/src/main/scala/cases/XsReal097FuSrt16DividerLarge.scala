...
// - testcase/xiangshan/src/main/scala/xiangshan/backend/fu/SRT16Divider.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal097FuSrt16DividerLarge extends Module {
