...
// - testcase/xiangshan/src/main/scala/xiangshan/frontend/icache/ICachePrefetchPipe.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal056IcacheIcacheprefetchpipeLarge extends Module {
