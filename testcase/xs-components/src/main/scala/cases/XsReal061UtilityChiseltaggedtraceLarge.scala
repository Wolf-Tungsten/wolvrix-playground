...
// - testcase/xiangshan/utility/src/main/scala/utility/ChiselTaggedTrace.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal061UtilityChiseltaggedtraceLarge extends Module {
