...
// - testcase/xiangshan/coupledL2/src/main/scala/coupledL2/CoupledL2.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal050Coupledl2Coupledl2Large extends Module {
