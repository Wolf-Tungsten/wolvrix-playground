...
// - testcase/xiangshan/coupledL2/src/main/scala/coupledL2/GrantBuffer.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal076Coupledl2GrantbufferLarge extends Module {
