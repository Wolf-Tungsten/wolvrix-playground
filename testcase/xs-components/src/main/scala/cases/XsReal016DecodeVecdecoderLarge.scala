...
// - testcase/xiangshan/src/main/scala/xiangshan/backend/decode/VecDecoder.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal016DecodeVecdecoderLarge extends Module {
