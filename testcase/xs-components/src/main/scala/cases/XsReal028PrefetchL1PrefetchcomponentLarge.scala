...
// - testcase/xiangshan/src/main/scala/xiangshan/mem/prefetch/L1PrefetchComponent.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal028PrefetchL1PrefetchcomponentLarge extends Module {
