...
// - testcase/xiangshan/src/main/scala/xiangshan/backend/fu/NewCSR/CSRPermitModule.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal065NewcsrCsrpermitmoduleLarge extends Module {
