...
// - testcase/xiangshan/coupledL2/src/main/scala/coupledL2/RequestArb.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal094Coupledl2RequestarbLarge extends Module {
