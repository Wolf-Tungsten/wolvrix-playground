...
// - testcase/xiangshan/src/main/scala/xiangshan/backend/rename/RenameTable.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal081RenameRenametableLarge extends Module {
