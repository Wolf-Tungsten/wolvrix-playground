...
// - testcase/xiangshan/src/main/scala/xiangshan/cache/mmu/BitmapCheck.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal062MmuBitmapcheckLarge extends Module {
