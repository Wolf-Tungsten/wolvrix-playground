...
// - testcase/xiangshan/src/main/scala/xiangshan/cache/mmu/PageTableWalker.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal012MmuPagetablewalkerLarge extends Module {
