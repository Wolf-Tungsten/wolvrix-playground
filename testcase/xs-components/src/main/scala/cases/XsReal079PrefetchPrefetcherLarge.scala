...
// - testcase/xiangshan/coupledL2/src/main/scala/coupledL2/prefetch/Prefetcher.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal079PrefetchPrefetcherLarge extends Module {
