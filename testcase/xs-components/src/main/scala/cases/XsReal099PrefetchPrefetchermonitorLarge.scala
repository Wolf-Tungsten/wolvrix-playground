...
// - testcase/xiangshan/src/main/scala/xiangshan/mem/prefetch/PrefetcherMonitor.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal099PrefetchPrefetchermonitorLarge extends Module {
