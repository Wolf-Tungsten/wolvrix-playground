...
// - testcase/xiangshan/coupledL2/src/main/scala/coupledL2/RequestBuffer.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal091Coupledl2RequestbufferLarge extends Module {
