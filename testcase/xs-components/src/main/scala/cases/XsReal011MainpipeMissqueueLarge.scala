...
// - testcase/xiangshan/src/main/scala/xiangshan/cache/dcache/mainpipe/MissQueue.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal011MainpipeMissqueueLarge extends Module {
