...
// - testcase/xiangshan/src/main/scala/xiangshan/frontend/ibuffer/IBuffer.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal069IbufferIbufferLarge extends Module {
