...
// - testcase/xiangshan/src/main/scala/xiangshan/mem/lsqueue/LoadQueueReplay.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal026LsqueueLoadqueuereplayLarge extends Module {
