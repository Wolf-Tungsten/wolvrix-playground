...
// - testcase/xiangshan/src/main/scala/xiangshan/backend/fu/NewCSR/InterruptFilter.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal087NewcsrInterruptfilterLarge extends Module {
