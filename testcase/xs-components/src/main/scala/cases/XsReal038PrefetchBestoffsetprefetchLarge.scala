...
// - testcase/xiangshan/coupledL2/src/main/scala/coupledL2/prefetch/BestOffsetPrefetch.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal038PrefetchBestoffsetprefetchLarge extends Module {
  ...
  private val lanes = 6
  private val updateWays = 2
  private val tapCount = 8
  private val salt = 535
