...
// - testcase/xiangshan/coupledL2/src/main/scala/coupledL2/tl2tl/MainPipe.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal037Tl2TlMainpipeLarge extends Module {
