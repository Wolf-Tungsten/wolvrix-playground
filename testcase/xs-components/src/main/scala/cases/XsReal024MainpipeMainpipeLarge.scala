...
// - testcase/xiangshan/src/main/scala/xiangshan/cache/dcache/mainpipe/MainPipe.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal024MainpipeMainpipeLarge extends Module {
