...
// - testcase/xiangshan/src/main/scala/xiangshan/cache/dcache/DCacheWrapper.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal006DcacheDcachewrapperLarge extends Module {
