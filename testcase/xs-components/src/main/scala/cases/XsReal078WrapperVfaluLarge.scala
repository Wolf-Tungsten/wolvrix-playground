...
// - testcase/xiangshan/src/main/scala/xiangshan/backend/fu/wrapper/VFALU.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal078WrapperVfaluLarge extends Module {
