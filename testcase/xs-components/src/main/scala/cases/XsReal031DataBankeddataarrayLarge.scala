...
// - testcase/xiangshan/src/main/scala/xiangshan/cache/dcache/data/BankedDataArray.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal031DataBankeddataarrayLarge extends Module {
