...
// - testcase/xiangshan/src/main/scala/xiangshan/mem/lsqueue/StoreQueueData.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal089LsqueueStorequeuedataLarge extends Module {
