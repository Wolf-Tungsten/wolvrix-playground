...
// - testcase/xiangshan/utility/src/main/scala/utility/sram/SRAMTemplate.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal044SramSramtemplateLarge extends Module {
