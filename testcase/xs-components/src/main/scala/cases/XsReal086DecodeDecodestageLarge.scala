...
// - testcase/xiangshan/src/main/scala/xiangshan/backend/decode/DecodeStage.scala
// This file is intentionally self-contained: no local xs-components helper,
// base class, or shared case template is referenced.
class XsReal086DecodeDecodestageLarge extends Module {
