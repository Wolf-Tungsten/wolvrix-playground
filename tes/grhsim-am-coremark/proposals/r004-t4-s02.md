# Proposal r004/t4/s02（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t4  step: 2/4
- 轨迹主线分支: `tes/r004/t4/main`  best: null
...
- 最新 recon: `build/tes/grhsim-am-coremark/recon/r004-t4-s00/report.md`（基于 eval e00085）
...
|---|---|---|---|---|---|---|
| e00085 | -193403 | 1.000 | 1.00 | 6 | 1.202 | * |
