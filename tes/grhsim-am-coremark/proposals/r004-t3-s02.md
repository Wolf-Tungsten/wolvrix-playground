# Proposal r004/t3/s02（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t3  step: 2/4
- 轨迹主线分支: `tes/r004/t3/main`  best: {"eval_id": "e00093", "score": -172530}
...
- 最新 recon: `build/tes/grhsim-am-coremark/recon/r004-t3-s00/report.md`（基于 eval e00085）
...
|---|---|---|---|---|---|---|
| e00093 | -172530 | 1.000 | 1.00 | 0 | 2.732 | * |
