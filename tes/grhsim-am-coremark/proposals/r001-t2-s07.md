# Proposal r001/t2/s07（Φ 自动生成）

- task: grhsim-am-coremark  run: r001  trajectory: t2  step: 7/8
- 轨迹主线分支: `tes/r001/t2/main`  best: {"eval_id": "e00037", "score": -257300}
...
### e00037（step 6, score -257300, host 中位 257300 ms）
- 假设: c1: t2 仅有的两个独立正收益机制（commit 输入门控 e00019 -1.95%、affinity+init消零 e00020 -1.66%）机制正交可组合，组合后 Host 中位较 e00019 降 >=1.5%；<0.5% 或回退则存在负交互、组合轴关闭
- 洞察: 确认：257.300s（253188/257865/257300，CV 1.0%），较 e00019 -2.71%，越 1.5% 假设门但低于全加性预期 -3.6%（部分可加）；17/17 ctest、3 rep difftest 全过，compile_s=623.9s（affinity+消零编译障碍在 t2 主线首次根治）
- 分支 `tes/r001/t2/s06-c1`  commit `0bd9a554614d`  结果 `build/tes/grhsim-am-coremark/evals/e00037/result.json`
...
|---|---|---|---|---|---|---|
| e00037 | -257300 | 1.000 | 1.00 | 0 | 3.828 | * |
| e00031 | -265250 | 0.900 | 0.67 | 1 | 1.843 |  |
| e00019 | -264466 | 0.810 | 0.83 | 2 | 1.596 | * |
| e00014 | -269731 | 0.900 | 0.50 | 2 | 1.371 |  |
| e00025 | -270956 | 0.810 | 0.33 | 1 | 1.281 |  |
| e00008 | -272743 | 0.810 | 0.17 | 3 | 0.928 | * |
| e00001 | -273103 | 0.900 | 0.00 | 9 | 0.900 |  |
