# Proposal r004/t1/s02（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t1  step: 2/4
- 轨迹主线分支: `tes/r004/t1/main`  best: {"eval_id": "e00089", "score": -190827}
...
- 最新 recon: `build/tes/grhsim-am-coremark/recon/r004-t1-s00/report.md`（基于 eval e00085）
...
|---|---|---|---|---|---|---|
| e00089 | -190827 | 1.000 | 1.00 | 0 | 2.732 | * |
