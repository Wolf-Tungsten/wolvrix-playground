# Proposal r004/t3/s03（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t3  step: 3/4
...
### e00106（step 2, score -166947, host 中位 166947 ms）
- 假设: Starting from e00093, e00085 recon assigns 1.567% of block cycles to b69157/b69158/b69159 and e00094 showed a 3.06% nominal Host gain from fusing their 92-step wide mux chains; combining that independent pool optimization with power-of-two indexing should improve Host by at least 0.75% versus e00093 while retaining its memory-read gain.
- 洞察: e00106 passed 17/17 ctest and three 73580/49996 difftest reps; 166.947s unimodal non-noisy Host improves 3.24% versus e00093 and 1.55% versus prior global best e00104, confirming the wide-mux fusion composes with power-of-two indexing beyond the 3% adjudication band.
- 分支 `tes/r004/t3/s02-c2`  commit `8c4585f67438`  结果 `build/tes/grhsim-am-coremark/evals/e00106/result.json`
...
|---|---|---|---|---|---|---|
| e00106 | -166947 | 1.000 | 1.00 | 0 | 3.000 | * |
| e00093 | -172530 | 0.900 | 0.50 | 1 | 1.400 |  |
| e00085 | -193403 | 0.810 | 0.00 | 10 | 0.810 | * |
