# Proposal r001/t2/s05（Φ 自动生成）

- task: grhsim-am-coremark  run: r001  trajectory: t2  step: 5/8
...
### e00025（step 4, score -270956, host 中位 270956 ms）
- 假设: 稀疏 commit-input gating 仅保留尾部工作量至少为 dirty edge 数 4 倍的 gate；若传播边开销主导，则拒绝低净收益 gate 可较 e00019 再降至少 1.5% Host time。
- 洞察: e00025 通过 17/17 ctest 与 3-rep difftest，271.0s 中位（271.725/265.956/270.956，CV 1.16%），较 e00019 264.466s 回退 2.45%；min_work_per_edge=4 拒绝 2922/2922 个 gate（240198 dirty edges），实际退化为 guard-event gating，稀疏阈值方向证伪。
- 分支 `tes/r001/t2/s04-c1`  commit `f7b1f87af710`  结果 `build/tes/grhsim-am-coremark/evals/e00025/result.json`
...
|---|---|---|---|---|---|---|
| e00019 | -264466 | 1.000 | 1.00 | 1 | 2.225 | * |
| e00014 | -269731 | 0.900 | 0.75 | 1 | 1.819 |  |
| e00025 | -270956 | 0.249 | 0.50 | 0 | 1.473 | * |
| e00008 | -272743 | 0.810 | 0.25 | 2 | 1.014 | * |
