# Proposal r004/t2/s02（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t2  step: 2/4
- 轨迹主线分支: `tes/r004/t2/main`  best: {"eval_id": "e00092", "score": -188662}
...
- 最新 recon: `build/tes/grhsim-am-coremark/recon/r004-t2-s00/report.md`（基于 eval e00085）
...
|---|---|---|---|---|---|---|
| e00092 | -188662 | 1.000 | 1.00 | 0 | 2.732 | * |
