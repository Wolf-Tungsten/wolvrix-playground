# Proposal r004/t0/s04（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t0  step: 4/4
- 轨迹主线分支: `tes/r004/t0/main`  best: {"eval_id": "e00100", "score": -172832}
...
### e00111（step 3, score -170564, host 中位 170564 ms）
- 假设: Migrating e00106's confirmed wide ArrayBroadcast-to-ArrayMux chain fusion onto e00100 will eliminate intermediate wide materialization in b69157/b69158/b69159, which still consume 1.683% of e00100 recon cycles, and improve Host by at least 1% while retaining the power-of-two memory-read gain.
- 洞察: e00111 passed all gates at 170.564s unimodal non-noisy Host, improving 1.31% versus e00100; the migrated mux fusion meets its 1% Host floor but stays inside the 3% confirmation band.
- 分支 `tes/r004/t0/s03-c1`  commit `611784ba1ade`  结果 `build/tes/grhsim-am-coremark/evals/e00111/result.json`
...
- e00099 s2c1: score -194205（194205 ms）— The e00088 division specialization plus event-first system-task predicates will remove the remaining fire-read work in recon-hot blocks 90656/90657 (4.683% of cycles) while retaining the b93085 division reduction; the combination should improve Host by at least 1% versus e00088 without changing pending or once transitions.
- e00112 s3c2: score -174258（174258 ms）— On e00100, b93159 and b93141 execute about 100k times each, span 8464/12189 instructions across 4/6 chunks, and consume 9.076% of recon cycles; raising block chunk size from 3000 to 6000 should halve their cross-function calls and improve Host by at least 1% without changing AM semantics.

## 本轨迹 recon 证据（动态病灶数据）

- 最新 recon: `build/tes/grhsim-am-coremark/recon/r004-t0-s02/report.md`（基于 eval e00100）
...
|---|---|---|---|---|---|---|
| e00111 | -170564 | 1.000 | 1.00 | 0 | 3.236 | * |
| e00100 | -172832 | 1.000 | 0.67 | 1 | 1.745 |  |
| e00088 | -189829 | 0.900 | 0.33 | 1 | 1.273 | * |
