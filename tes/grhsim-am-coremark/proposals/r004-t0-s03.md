# Proposal r004/t0/s03（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t0  step: 3/4
...
### e00100（step 2, score -172832, host 中位 172832 ms）
- 假设: Migrating confirmed e00093 power-of-two memory-read indexing onto e00088 will retain the division improvement while removing 3,072 index_words calls from six recon-hot blocks carrying 3.140% of cycles; the combination should improve Host by at least 5% versus e00088.
- 洞察: e00100 passed 17/17 ctest and three 73580/49996 difftest reps; 172.832s unimodal non-noisy Host improves 8.95% versus e00088 and is within 0.18% of e00093, confirming the migrated power-of-two index gain transfers while division adds no resolvable increment.
- 分支 `tes/r004/t0/s02-c2`  commit `8cb0b6ee1bfe`  结果 `build/tes/grhsim-am-coremark/evals/e00100/result.json`
...
|---|---|---|---|---|---|---|
| e00100 | -172832 | 1.000 | 1.00 | 0 | 3.000 | * |
| e00088 | -189829 | 0.900 | 0.50 | 1 | 1.400 |  |
| e00085 | -193403 | 0.810 | 0.00 | 7 | 0.810 | * |
