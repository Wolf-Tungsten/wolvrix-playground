# Proposal r004/t4/s03（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t4  step: 3/4
- 轨迹主线分支: `tes/r004/t4/main`  best: {"eval_id": "e00108", "score": -189263}
...
### e00108（step 2, score -189263, host 中位 189263 ms）
- 假设: Phi e00085 and t4/s01 c2 ctest feedback -> recon b90656/b90657 consume 4.923% of block cycles while stock, outline, and run fixtures are byte-identical but the test expected 9 rather than 15 data lines -> correct that fixture and merge adjacent outlined fwrite calls with identical immediate fire predicates into one branch -> expect the pool to fall at least 20% and Host time at least 1%, otherwise falsified
- 洞察: e00108=189.263s，较 e00085 改善 2.14%；17/17 ctest 与三次 73580/49996 difftest 全过，单簇 CV 1.47%、非 noisy；达到 1% 预期但仍在 3% 确认带内，比 e00107 快 0.31% 不可分辨。
- 分支 `tes/r004/t4/s02-c2`  commit `d3d418133d1c`  结果 `build/tes/grhsim-am-coremark/evals/e00108/result.json`
...
|---|---|---|---|---|---|---|
| e00108 | -189263 | 1.000 | 1.00 | 0 | 2.732 | * |
| e00085 | -193403 | 0.900 | 0.00 | 11 | 0.900 |  |
