# Proposal r004/t1/s03（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t1  step: 3/4
- 轨迹主线分支: `tes/r004/t1/main`  best: {"eval_id": "e00102", "score": -171233}
...
### e00102（step 2, score -171233, host 中位 171233 ms）
- 假设: Migrating confirmed e00093 power-of-two memory-read indexing onto e00089 should retain its host-call guard-cache effect while removing 3,072 index_words calls and unreachable bounds branches from six e00085-recon blocks carrying 3.140% of cycles; the combination should improve Host by at least 5% versus e00089.
- 洞察: e00102 passed 17/17 ctest and three 73580/49996 difftest reps; 171.233s unimodal non-noisy Host improves 10.27% versus e00089 and 0.75% versus source e00093, confirming the pow2-index mechanism transfers while guard caching remains weakly additive.
- 分支 `tes/r004/t1/s02-c2`  commit `da88c2a4c45a`  结果 `build/tes/grhsim-am-coremark/evals/e00102/result.json`
...
|---|---|---|---|---|---|---|
| e00102 | -171233 | 1.000 | 1.00 | 0 | 3.000 | * |
| e00089 | -190827 | 0.900 | 0.50 | 1 | 1.400 |  |
| e00085 | -193403 | 0.810 | 0.00 | 8 | 0.810 | * |
