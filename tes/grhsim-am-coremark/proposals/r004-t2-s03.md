# Proposal r004/t2/s03（Φ 自动生成）

- task: grhsim-am-coremark  run: r004  trajectory: t2  step: 3/4
...
### e00104（step 2, score -169577, host 中位 169577 ms）
- 假设: Migrating confirmed e00093 power-of-two memory-read indexing onto e00092 should retain exact-predicate host-call run savings while removing 3,072 index_words calls and unreachable bounds branches from six e00085-recon blocks carrying 3.140% of cycles; the combination should improve Host by at least 5% versus e00092.
- 洞察: e00104 passed 17/17 ctest and three 73580/49996 difftest reps with the declared 14-switch phenotype; 169.577s unimodal non-noisy Host improves 10.11% versus e00092 and 1.71% versus migration source e00093, confirming pow2 indexing transfers while the predicate-run increment remains inside the 3% resolution band.
- 分支 `tes/r004/t2/s02-c2`  commit `3f37f45837c0`  结果 `build/tes/grhsim-am-coremark/evals/e00104/result.json`
...
|---|---|---|---|---|---|---|
| e00104 | -169577 | 1.000 | 1.00 | 0 | 3.000 | * |
| e00092 | -188662 | 0.900 | 0.50 | 1 | 1.400 |  |
| e00085 | -193403 | 0.810 | 0.00 | 9 | 0.810 | * |
