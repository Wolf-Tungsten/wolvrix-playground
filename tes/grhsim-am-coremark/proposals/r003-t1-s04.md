# Proposal r003/t1/s04（Φ 自动生成）

- task: grhsim-am-coremark  run: r003  trajectory: t1  step: 4/8
...
### e00064（step 3, score -409731, host 中位 409731 ms）
- 假设: e00056/e00059 -> recon 显示 23-level selector 机会密度仅0.0188%，但全局 sparse scatter 会破坏连续 base 流 -> 每个64-lane tile先OR全部selector，全零直接连续复制/填充base，非零才保留原branchless level replay -> 预期 Host 至少下降1.5%，低于0.5%或回退证伪
- 洞察: e00064 ok，17/17 ctest与3-rep difftest 73580/49996全过，compile_s=2229.3s；Host 409.731/409.730/409.741s，中位409.731s，CV=0，起跑loadavg 50.18；同高负载窗口较noisy c1快17.31%成为机械winner，但较历史e00059慢59.28%，绝对机制收益仍受宿主慢窗混杂
- 分支 `tes/r003/t1/s03-c2`  commit `0f3fd046eb68`  结果 `build/tes/grhsim-am-coremark/evals/e00064/result.json`
...
|---|---|---|---|---|---|---|
| e00056 | -241956 | 1.000 | 1.00 | 2 | 1.745 | * |
| e00059 | -257235 | 0.909 | 0.67 | 1 | 1.654 |  |
| e00051 | -363995 | 0.900 | 0.33 | 4 | 1.049 |  |
| e00064 | -409731 | 0.000 | 0.00 | 0 | 0.000 | * |
