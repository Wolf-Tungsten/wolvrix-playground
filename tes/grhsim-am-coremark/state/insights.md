...
## r004 run-init：e00057 起点与双基线重锚（2026-08-23，action A0084）

- **起点已冻结并合入用户主线**：r003/e00057 `1563c3d837fc`（task-body outline +
  scan branch hints，完整 12 开关表型）fast-forward 到 wolvrix
  `grh/tes-grhsim-am`；r004 base 与 t0..t5/main 均指向同一 commit。输入 SHA-256
  仍为 `cbd78c0b...b3246`，C/L/K=6/4/2，N=48。
- **AM e00085**：348716/354109/348711ms，快簇中位 348716ms，unimodal，CV
  0.89%，非 noisy；compile_s 1072.0s，17/17 ctest 与 3 rep difftest
  73580/49996 全过。
- **gsim e00086**：50275/50273/50688ms，快簇中位 50275ms，unimodal，CV
  0.47%，非 noisy；3 rep difftest 73584/49998 全过。r004 起跑差距 **6.936x**。
- **跨窗水位裁决**：同 commit/表型 e00085 比历史 e00057 229.429s 慢 51.99%，而
  gsim 比 r003/e00052 慢 9.62%；本批单簇仅证明当前窗口内部稳定，不证明代码回退。
  后续候选必须用同窗/同簇证据，round 2 中段按协议 retime 两个基线。
- 下一 action 为 t0/e00085 recon；先取得当前生产表型的动态热点，再设计 K=2 候选。
