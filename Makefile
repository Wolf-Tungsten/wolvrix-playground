...
# Keep the default GrhSIM scheduling knobs aligned with testcase/xs-components.
XS_WOLF_GRHSIM_MAX_OP_IN_COMPUTE_SUPERNODE ?= 8
...
XS_WOLF_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE ?= 768
XS_WOLF_GRHSIM_TOPO_ORDER_MODEL ?= layer
...
XS_WOLF_GRHSIM_ENABLE_ESSENT_MFFC_BUILD ?= 0
XS_WOLF_GRHSIM_ENABLE_ESSENT_COARSEN ?= 0
XS_WOLF_GRHSIM_ENABLE_ESSENT_SINGLE_PARENT_MERGE ?= 1
XS_WOLF_GRHSIM_ENABLE_ESSENT_SMALL_SIBLING_MERGE ?= 1
XS_WOLF_GRHSIM_ENABLE_ESSENT_SMALL_OVERLAP_MERGE ?= 1
XS_WOLF_GRHSIM_ENABLE_ESSENT_DOWN_MERGE ?= 1
XS_WOLF_GRHSIM_ESSENT_SMALL_SIBLING_MAX_PREDS ?= 1
XS_WOLF_GRHSIM_ESSENT_SMALL_SIBLING_CANDIDATE_BUDGET ?= 250000
...
xs_wolf_grhsim_emit: $(XS_WOLF_FILELIST_ABS) $(XS_WOLF_DEPS)
	...
	@printf "%s\n" $(XS_WOLF_INCLUDE_FLAGS) $(XS_WOLF_DEFINE_FLAGS) >> "$(XS_READ_ARGS_FILE)"
	@set -o pipefail; { \
		echo "[CMD] WOLVRIX_XS_GRHSIM_RESUME_FROM_STATS_JSON=$(XS_WOLF_GRHSIM_RESUME_FROM_STATS_JSON) WOLVRIX_XS_GRHSIM_POST_STATS_JSON=$(XS_WOLF_GRHSIM_POST_STATS_JSON_ABS) WOLVRIX_XS_GRHSIM_MAX_OP_IN_COMPUTE_SUPERNODE=$(XS_WOLF_GRHSIM_MAX_OP_IN_COMPUTE_SUPERNODE) WOLVRIX_XS_GRHSIM_MAX_VALUE_IN_COMPUTE_SUPERNODE=$(XS_WOLF_GRHSIM_MAX_VALUE_IN_COMPUTE_SUPERNODE) WOLVRIX_XS_GRHSIM_TARGET_COMPUTE_SUPERNODES=$(XS_WOLF_GRHSIM_TARGET_COMPUTE_SUPERNODES) WOLVRIX_XS_GRHSIM_MAX_VALUE_IN_COMPUTE_NODE=$(XS_WOLF_GRHSIM_MAX_VALUE_IN_COMPUTE_NODE) WOLVRIX_XS_GRHSIM_MAX_DECLARED_VALUE_IN_COMPUTE_NODE=$(XS_WOLF_GRHSIM_MAX_DECLARED_VALUE_IN_COMPUTE_NODE) WOLVRIX_XS_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE=$(XS_WOLF_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE) WOLVRIX_XS_GRHSIM_TOPO_ORDER_MODEL=$(XS_WOLF_GRHSIM_TOPO_ORDER_MODEL) WOLVRIX_XS_GRHSIM_SCHED_BATCH_TARGET_COUNT=$(XS_WOLF_GRHSIM_SCHED_BATCH_TARGET_COUNT) WOLVRIX_XS_GRHSIM_EMIT_PARALLELISM=$(XS_WOLF_GRHSIM_EMIT_PARALLELISM) WOLVRIX_XS_GRHSIM_ENABLE_ESSENT_COARSEN=$(XS_WOLF_GRHSIM_ENABLE_ESSENT_COARSEN) $(PYTHON) $(XS_WOLVRIX_GRHSIM_SCRIPT) $(XS_WOLF_FILELIST_ABS) $(XS_SIM_TOP) $(XS_WOLF_GRHSIM_EMIT_DIR_ABS) $(XS_WOLF_GRHSIM_JSON) $(XS_READ_ARGS_FILE) $(WOLF_LOG) --waveform $(if $(filter 1,$(WOLVRIX_GRHSIM_WAVEFORM)),declared-symbols,off) --perf $(if $(filter 1,$(WOLVRIX_GRHSIM_PERF)),eval,off)"; \
		...
		WOLVRIX_XS_GRHSIM_MAX_VALUE_IN_COMPUTE_SUPERNODE="$(XS_WOLF_GRHSIM_MAX_VALUE_IN_COMPUTE_SUPERNODE)" \
		WOLVRIX_XS_GRHSIM_TARGET_COMPUTE_SUPERNODES="$(XS_WOLF_GRHSIM_TARGET_COMPUTE_SUPERNODES)" \
		WOLVRIX_XS_GRHSIM_MAX_VALUE_IN_COMPUTE_NODE="$(XS_WOLF_GRHSIM_MAX_VALUE_IN_COMPUTE_NODE)" \
		WOLVRIX_XS_GRHSIM_MAX_DECLARED_VALUE_IN_COMPUTE_NODE="$(XS_WOLF_GRHSIM_MAX_DECLARED_VALUE_IN_COMPUTE_NODE)" \
		...
		WOLVRIX_XS_GRHSIM_ENABLE_ESSENT_MFFC_BUILD="$(XS_WOLF_GRHSIM_ENABLE_ESSENT_MFFC_BUILD)" \
		WOLVRIX_XS_GRHSIM_ENABLE_ESSENT_COARSEN="$(XS_WOLF_GRHSIM_ENABLE_ESSENT_COARSEN)" \
		WOLVRIX_XS_GRHSIM_ENABLE_ESSENT_SINGLE_PARENT_MERGE="$(XS_WOLF_GRHSIM_ENABLE_ESSENT_SINGLE_PARENT_MERGE)" \
		WOLVRIX_XS_GRHSIM_ENABLE_ESSENT_SMALL_SIBLING_MERGE="$(XS_WOLF_GRHSIM_ENABLE_ESSENT_SMALL_SIBLING_MERGE)" \
		WOLVRIX_XS_GRHSIM_ENABLE_ESSENT_SMALL_OVERLAP_MERGE="$(XS_WOLF_GRHSIM_ENABLE_ESSENT_SMALL_OVERLAP_MERGE)" \
		WOLVRIX_XS_GRHSIM_ENABLE_ESSENT_DOWN_MERGE="$(XS_WOLF_GRHSIM_ENABLE_ESSENT_DOWN_MERGE)" \
		WOLVRIX_XS_GRHSIM_ESSENT_SMALL_SIBLING_MAX_PREDS="$(XS_WOLF_GRHSIM_ESSENT_SMALL_SIBLING_MAX_PREDS)" \
		WOLVRIX_XS_GRHSIM_ESSENT_SMALL_SIBLING_CANDIDATE_BUDGET="$(XS_WOLF_GRHSIM_ESSENT_SMALL_SIBLING_CANDIDATE_BUDGET)" \
