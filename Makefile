...
XS_WOLF_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE_OVERRIDE = $(strip $(if $(XS_WOLF_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE),$(XS_WOLF_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE),$(WOLVRIX_XS_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE)))
...
XS_REPCUT_WEIGHT_MODE ?= baseline
...
xs_wolf_grhsim_emit: $(XS_WOLF_FILELIST_ABS) $(XS_WOLF_DEPS)
	...
	@set -o pipefail; { \
		...
		$(if $(XS_WOLF_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE_OVERRIDE),WOLVRIX_XS_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE="$(XS_WOLF_GRHSIM_MAX_OP_IN_COMMIT_SUPERNODE_OVERRIDE)" )WOLVRIX_XS_GRHSIM_SCHED_BATCH_MAX_OPS="$(XS_WOLF_GRHSIM_SCHED_BATCH_MAX_OPS)" \
...
run_xs_repcut: py_install
	...
	@echo "[CMD] XS_REPCUT_WEIGHT_MODE=$(XS_REPCUT_WEIGHT_MODE) $(PYTHON) $(XS_WOLVRIX_REPCUT_SCRIPT) $(XS_WOLF_JSON) $(XS_WOLF_REPCUT_JSON) $(XS_REPCUT_WORK_DIR_ABS) $(WOLF_LOG)"
	@set -o pipefail; XS_REPCUT_WEIGHT_MODE="$(XS_REPCUT_WEIGHT_MODE)" $(PYTHON) $(XS_WOLVRIX_REPCUT_SCRIPT) \
		$(XS_WOLF_JSON) \
		$(XS_WOLF_REPCUT_JSON) \
...
run_xs_repcut_partitioned_smoke: py_install
	...
	@echo "[CMD] XS_REPCUT_WEIGHT_MODE=$(XS_REPCUT_WEIGHT_MODE) $(PYTHON) $(XS_WOLVRIX_REPCUT_SCRIPT) $(XS_WOLF_JSON) $(XS_WOLF_REPCUT_JSON) $(XS_REPCUT_WORK_DIR_ABS) $(WOLF_LOG) $(XS_WOLF_REPCUT_PACKAGE_DIR_ABS)"
	@set -o pipefail; XS_REPCUT_WEIGHT_MODE="$(XS_REPCUT_WEIGHT_MODE)" $(PYTHON) $(XS_WOLVRIX_REPCUT_SCRIPT) \
		$(XS_WOLF_JSON) \
		$(XS_WOLF_REPCUT_JSON) \
		$(XS_REPCUT_WORK_DIR_ABS) \
