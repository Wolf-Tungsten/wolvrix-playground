...
# GSIM partitions coarse FIRRTL nodes, while activity-schedule counts GRH op atoms.
# For XiangShan, 108 op atoms keeps the total supernode count close to GSIM's max-size=15 run.
