...
XS_WOLF_GRHSIM_MAX_OP_IN_COMPUTE_NODE ?= 8192
...
xs_wolf_grhsim_emit: $(XS_WOLF_FILELIST_ABS) $(XS_WOLF_DEPS)
	...
	@set -o pipefail; { \
		...
		WOLVRIX_XS_GRHSIM_MAX_COMPUTE_NODE_IN_COMPUTE_SUPERNODE="$(XS_WOLF_GRHSIM_MAX_COMPUTE_NODE_IN_COMPUTE_SUPERNODE)" \
		WOLVRIX_XS_GRHSIM_MAX_VALUE_IN_COMPUTE_SUPERNODE="$(XS_WOLF_GRHSIM_MAX_VALUE_IN_COMPUTE_SUPERNODE)" \
		WOLVRIX_XS_GRHSIM_TARGET_COMPUTE_SUPERNODES="$(XS_WOLF_GRHSIM_TARGET_COMPUTE_SUPERNODES)" \
		WOLVRIX_XS_GRHSIM_MAX_OP_IN_COMPUTE_NODE="$(XS_WOLF_GRHSIM_MAX_OP_IN_COMPUTE_NODE)" \
