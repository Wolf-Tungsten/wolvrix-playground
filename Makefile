...
XS_WOLF_GRHSIM_AM_MAX_INSTRUCTIONS_PER_BLOCK ?= 128
XS_WOLF_GRHSIM_AM_BLOCK_FORMATION ?= greedy
XS_WOLF_GRHSIM_AM_DP_SEGMENT_PENALTY ?= 64
XS_WOLF_GRHSIM_AM_DP_COARSEN_BUDGET ?= 0
...
xs_wolf_grhsim_am_emit: $(XS_WOLF_FILELIST_ABS) xs_grhsim_am_tool
	...
	@set -o pipefail; { \
		...
		$(PYTHON) "$(XS_WOLVRIX_GRHSIM_AM_SCRIPT)" \
			...
			--max-instructions-per-block "$(XS_WOLF_GRHSIM_AM_MAX_INSTRUCTIONS_PER_BLOCK)" \
			--block-formation "$(XS_WOLF_GRHSIM_AM_BLOCK_FORMATION)" \
			--dp-segment-penalty "$(XS_WOLF_GRHSIM_AM_DP_SEGMENT_PENALTY)" \
			--dp-coarsen-budget "$(XS_WOLF_GRHSIM_AM_DP_COARSEN_BUDGET)" \
